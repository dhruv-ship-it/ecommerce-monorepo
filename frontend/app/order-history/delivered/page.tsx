    ...
    async function fetchOrders() {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const deliveredOrders = ordersArray.filter((order: Order) => order.OrderStatus === 'Delivered')
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        <div className="text-xl">Loading your delivered orders...</div>
      </div>
    )
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {Array.isArray(orders) && orders.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-muted-foreground mb-6">Your delivered orders will appear here once they arrive.</p>
          <Link href="/models">
