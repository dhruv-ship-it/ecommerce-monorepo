  ...
  const fetchCustomers = useCallback(async () => {
    try {
      const response = await fetch(
        `http://localhost:4000/su/customers?page=${page}&limit=10`,
        {
          headers: {
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4 text-blue-600">
                <span className="text-blue-600 font-bold">Manage Customers</span>
              </h3>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {Array.isArray(customers) && customers.map((customer) => (
                      <tr key={customer.CustomerId}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <Link href={`/su-dashboard/manage-customers/edit/${customer.CustomerId}`} className="text-blue-600 hover:text-blue-900 mr-2">
                            Edit
                          </Link>
                          <button
